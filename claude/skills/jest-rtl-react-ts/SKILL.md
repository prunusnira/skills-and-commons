---
name: jest-rtl-react-ts
description: "Vite + React + TypeScript 프로젝트에서 Jest와 React Testing Library로 테스트를 작성, 수정, 리뷰할 때 따르는 기준. 접근 가능한 query, user-event, 외부 경계 mock, React Router, Vite 환경 변수와 정적 자산, jsdom 설정을 다룬다."
---

# Jest React 테스트 작성 Skill
